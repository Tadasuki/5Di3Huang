      ...
      <div className="container">
        <div className="about-hero">
          ...
          <div className="about-desc">
            <p>「五帝三皇神圣事」是一个AI辅助制作的开源的历史人物百科数据库，但，<strong>对于内容方面，本站坚决控制AIGC的数量与质量，请读者放心阅读。主要文字皆由编者本人亲自查阅资料并编写，AI仅用于辅助，且生成内容都经由本人审查后才加入、上线。</strong>本站名称取自上方毛泽东词《贺新郎·读史》，这几句词以历史唯物主义的视角客观梳理了华夏几千载的统治更迭，非常契合本站主题。网站图标为一个钟表，抽象自司马光“君者表也，臣者景也，表动则景随矣。” 这里的“表”是指标杆，也就是中国古代的钟——日晷的那根标杆，暗喻统治者应当为天下之表率，最起码要做对得起人民的事情。</p>
            <p>网站建立的最初灵感，来源于互联网上广受欢迎的各类性格测试与人物原型分析。我最初只是想让用户通过答题寻找“自己最像哪位君主/领袖”。但随着思考的深入，我开始向更深处扎根：我不仅想让用户知道自己“像谁”，更想让用户探寻这些执政者究竟“是谁”，于是我们需要一个更亲近读者的数据库去记录这些执政者。在我之前，中文互联网上也早已存在这些做得很好的网站，例如全历史（<a href="https://www.allhistory.com" target="_blank" rel="noopener noreferrer" style={{ color: '#4a9eff', textDecoration: 'underline' }}>allhistory.com</a>），全历史网页的内容制作精良，不仅收录了国内外重要人物，还记载了丰富的历史事件等。但是我们要做的事情和他们不一样。</p>
            <p>我不仅仅想要向大家传递历史，更想传递一个核心观点——<strong>封建帝王与现代领袖都不应是高高在上的。</strong> 与毛泽东诗词所传达的思想一致，历史唯物主义清醒地揭示：<strong>唯有人民，才是创造历史的真正动力。</strong> 哪怕是史册中最耀眼的星辰，也不过是历史大潮激荡起的浪花。即使是传统叙事中所谓“仁政之君”，也往往无法掩盖其虚伪的反动本质；他们的所谓“仁政”并非源于纯粹的仁慈，而是为了巩固自己的统治地位。这些事实不仅体现在古代君主皇帝，也适用于现代所谓的主席书记、民选总统。我不想要、也不需要为了所谓的出版物经营许可证和各种各样的备案去审核自己的内容，更不会去迎合任何政党、意识形态。我反对任何宏大叙事的内容，因为我在此记录人物，并非源于英雄史观的崇拜，而是为了从这些鲜活的个体与剧变的时代中，看到那不以人的意志为转移的历史规律，从而照见我们每一个人自己，<strong>我们坚信历史不是由君主帝王和伟大领袖创造的，而是由你、我这样平凡的民众共同书写的</strong>。</p>
            <p>编者本人是一名双重外行，既不是历史等文学专业的学生，也不是计算机等带电工科专业的学生，只凭热爱建立此站，如有纰误敬请友好指正。随着基础框架的搭建，未来的扩展将聚焦于：数据打磨（重大事件与历史人物）、更多维的资料联动（体制与疆域面积演变）、增强地理历史学、分子人类学等自然学科和理工科的交叉内容。以及构建更广泛的网状知识体系图谱。</p>
          </div>
        </div>
        ...
        <div className="about-disclaimer" style={{ marginTop: 'var(--space-xl)', marginBottom: 'var(--space-3xl)', padding: 'var(--space-xl)', background: 'color-mix(in srgb, var(--color-vermilion) 8%, transparent)', borderRadius: 'var(--radius-lg)', border: '1px solid color-mix(in srgb, var(--color-vermilion) 30%, transparent)' }}>
          ...
          <div style={{ color: 'var(--color-text-secondary)', lineHeight: 1.8, fontSize: '1rem' }}>
            <p style={{ marginBottom: 'var(--space-md)' }}>
              我们深知，历史人物的评价往往具有极强的时代局限性与主观色彩。本网站的资料为四方收集而来，并经过编者数轮琢磨，力求有一定程度的真实性，以及保持客观与中立。但既然由人写出，难免带有个人主观色彩，还请读者见谅。因此请不要参考本站内容作正规的研究，但你依旧可以根据本站内容，搜索我所给出的正式参考资料、文献、书籍内容进行深入研究。
            </p>
            <p style={{ marginBottom: 'var(--space-md)' }}>
              本站持坚定的历史唯物主义观点，这无可避免地会受到现有古籍文献倾向甚至现代史观的干扰。部分历史见解、评分维度、或是特定人物政权的归属认定，可能<strong>不能符合所有访客的观念</strong>（例如两岸各自的正统政治性叙事准则）。
            </p>
            <p style={{ marginBottom: 'var(--space-md)' }}>
              <strong>我绝对无意、也不对、更坚决反对任何刻意美化或抹黑历史执政者的行为</strong>。不论是千古一帝还是伟大领袖，盖棺定论，他们的历史功过均已成为过往云烟，本项目仅仅作为一份数字化归档。请各位访客<strong>务必辩证看待</strong>。再次声明，切莫将本站数据作为严格的学术引用或者敏感的政治辩论依据。因教育背景与认知差异带来的冒犯，我们在此提前致以诚挚的歉意。
            </p>
            <p style={{ marginBottom: '0', marginTop: 'var(--space-lg)', padding: 'var(--space-md)', background: 'rgba(0,0,0,0.15)', borderRadius: 'var(--radius-md)', fontSize: '1rem' }}>
              <strong>错误指正：</strong> 鉴于文明历史浩如烟海，错漏在所难免（如事件细节错误、单倍群归属错误等）。在此恳请大家发现事实性错误时，移步 GitHub 提交 Issue 友好指出，我们将尽快核实并修正！友好交流，理性读史。
            </p>
          </div>
        </div>
